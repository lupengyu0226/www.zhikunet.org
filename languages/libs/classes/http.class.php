...
class http {
	...
	function get_httpstatus($url){
			...
			curl_setopt($curl,CURLOPT_USERAGENT,'Baiduspider-news+(+http://www.baidu.com/search/spider.htm)');
			curl_exec($curl);
			$HTTP_CODE=curl_getinfo($curl,CURLINFO_HTTP_CODE);;
			curl_close($curl);
			return $HTTP_CODE;//TRUE; 	返回数组	
		}
