...
final class mysql {
	 ...
	 * @return array
	 * @return IF：05.27增加IF判断资源为空
	 */
	public function fetch_next($type=MYSQL_ASSOC,$sql='') {
		if(is_resource($this->lastqueryid)) {
	...
	public function halt($message = '', $sql = '') {
		if($this->config['debug']) {
			$this->errormsg = "<b>MySQL Query : </b> $sql <br /><b> MySQL Error : </b>".$this->error()." <br /> <b>MySQL Errno : </b>".$this->errno()." <br /><b> Message : </b> $message <br /><a href='http://faq.05273.cn/?errno=".$this->errno()."&msg=".urlencode($this->error())."' target='_blank' style='color:red'>Need Help?</a>";
			$msg = $this->errormsg;
