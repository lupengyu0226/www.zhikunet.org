...
<tbody>
	...
	<tr>
		<th width="50"><?php echo L('content')?>:</th>
                 <td><textarea readonly/disabled name="jubao[content]" id="content" rows=12 cols=60><?php echo L(addslashes(htmlspecialchars($an_info['content'])))?></textarea></td>

	</tr>
	<tr>
		<th width="50"><?php echo L('jianyi')?>:</th>
		<td><textarea readonly/disabled name="jubao[jianyi]" id="jianyi" rows=5 cols=60><?php echo L(addslashes(htmlspecialchars($an_info['jianyi'])))?></textarea></td>
	</tr>
	<tr>
		<th width="50"><?php echo L('status')?>:</th>
    <td width="20%" ><a href="?app=jubao&controller=jubao&view=public_status&id=<?php echo $an_info['id']?>&status=<?php echo $an_info['status']==0 ? 1 : 0?>"><?php echo $an_info['status']==0 ? L('status_0') : L('status_1')?></a></td>
	</tr>
	<tr>
