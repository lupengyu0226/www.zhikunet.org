...
if(empty($_GET['session_code']) || preg_match('/^([a-z0-9])$/i',$_GET['session_code']) || $_SESSION['code']!= strtolower($_GET['session_code'])) exit('-101');
...
if(!preg_match('/^(?:13\d{9}|15[0|1|2|3|5|6|7|8|9]\d{8}|18[0|2|3|5|6|7|8|9]\d{8}|14[5|7]\d{8}|17\d{9}|19[8|9]\d{8}|16[6]\d{8})$/',$mobile)) exit('mobile phone error');
...
shy_base::load_app_class('smsapi', 'sms', 0); //引入smsapi类
