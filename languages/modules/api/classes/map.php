...
$defaultcity = $_GET['defaultcity'] ? $_GET['defaultcity'] : ($setting['defaultcity'] ? $setting['defaultcity'] : '沭阳');
...
<?php if($maptype == 1) {?>
<script src="https://app.mapabc.com/apis?&t=flashmap&v=2.4&key=<?php echo $key?>&hl=zh-CN" type="text/javascript"></script>
<?php } elseif($maptype == 2) {?>
<script type="text/javascript" src="//api.map.baidu.com/api?v=2.0&ak=B5dc604fc3c74d4f300e0fd97761ab75"></script></script>
<?php }?>
...
<SCRIPT LANGUAGE="JavaScript">
  ...
  if(window.top.$('#<?php echo $field?>').val()) {
	...
	function keywordSearch(city) {
		...
		var url = "index.php?app=api&controller=index&op=map&city="+city;
