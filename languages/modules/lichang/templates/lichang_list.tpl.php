...
<input type="hidden" value="lichang" name="app">
<input type="hidden" value="lichang_admin" name="controller">
...
<table width="100%" cellspacing="0">
	<thead>
		<tr>
			...
			<?php foreach ($lichang_program as $k=>$v) {
...
?>
    <tr>
		...
		<?php foreach ($lichang_program as $k=>$b) {
				$d = 'n'.$k;
