...
<div class="pad_10">
<form action="?app=link&controller=link&view=edit&linkid=<?php echo $linkid; ?>" method="post" name="myform" id="myform">
<table cellpadding="2" cellspacing="1" class="table_form" width="100%">
	...
	<tr>
		<th><?php echo L('robots')?>：</th>
		<td><input name="link[robots]" type="radio" value="0" <?php if($robots==0){echo "checked";}?>>&nbsp;<?php echo L('yes')?>&nbsp;&nbsp;<input
			name="link[robots]" type="radio" value="99" <?php if($robots==99){echo "checked";}?>>&nbsp;<?php echo L('no')?></td>
	</tr>
	<tr>
...
<tr>
		<th></th>
		<td><input type="hidden" name="forward" value="?app=link&controller=link&view=edit"> <input
