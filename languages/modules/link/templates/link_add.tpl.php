...
<div class="pad_10">
<form action="?app=link&controller=link&view=add" method="post" name="myform" id="myform">
...
<tr>
		<th></th>
		<td><input type="hidden" name="forward" value="?app=link&controller=link&view=add"> <input
