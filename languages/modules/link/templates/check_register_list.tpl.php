...
?>
<div class="pad-lr-10">
<form name="myform" id="myform" action="?app=link&controller=link&view=check_register&safe_edi=<?php echo $_SESSION['safe_edi']?>" method="post" onsubmit="checkuid();return false;">
...
<input name="dosubmit" type="submit" class="button"
	...
	onClick="return confirm('<?php echo L('pass_or_not')?>')">&nbsp;&nbsp;<input type="submit" class="button" name="dosubmit" onclick="document.myform.action='?app=link&controller=link&view=delete'" value="<?php echo L('delete')?>"/> </div>
