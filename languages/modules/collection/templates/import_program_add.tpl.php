...
<div class="pad-lr-10">
<form name="myform" action="?app=collection&controller=node&view=import_program_add&nodeid=<?php if(isset($nodeid)) echo $nodeid?>&type=<?php echo $type?>&ids=<?php echo $ids?>&catid=<?php echo $catid?>" method="post" id="myform">
<fieldset>
	<legend><?php echo L('the_new_publication_solutions')?></legend>
		...
		<tr>
			...
			<td>
			<label><input name="add_introduce" type="checkbox"  value="1"><?php echo L('if_the_contents_of_intercepted')?></label><input type="text" name="introcude_length" value="300" size="3"><?php echo L('characters_to_a_summary_of_contents')?>
			</td>
		</tr>
		<tr>
