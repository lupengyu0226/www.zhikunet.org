...
<fieldset>
	...
	<input type="hidden" name="view" value="import_program_add">
...
?>
<span style="margin-right:10px;"><a href="?app=collection&controller=node&view=import_program_del&id=<?php echo $v['id']?>" style="color:#ccc"><?php echo L('delete')?></a></span>
<?php
	}
...
?>
	...
	<input type="hidden" name="app" value="collection">
	<input type="hidden" name="controller" value="node">
	<input type="hidden" name="view" value="import_content">
	<input type="hidden" name="nodeid" value="<?php if(isset($nodeid)) echo $nodeid?>">
	<input type="hidden" name="type" value="<?php echo $type?>">
	<input type="hidden" name="ids" value="<?php echo $ids?>">
<div class="btn">
