...
<form name="myform" action="?app=collection&controller=node&view=<?php echo ROUTE_A?>&nodeid=<?php if(isset($nodeid)) echo $nodeid?>" method="post" id="myform">
...
<fieldset>
	...
	<table width="100%" class="table_form">
	    ...
	    <tr>
	   <td width="120"><?php echo L('分类')?>：</td>
	    <td><select name="data[typeid]" id="">
		    <option value="0" <?php if($typeid=='0'){echo "selected";}?>>默认采集</option>
		    <?php
		      $i=0;
		      ...
		      //var_dump($typeid);
		    ?>
		    <option value="<?php echo $type['typeid'];?>" <?php if($type['typeid']==$data['typeid']){echo "selected";}?>><?php echo $type['name'];?></option>
		    <?php }?>
