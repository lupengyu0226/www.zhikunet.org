...
?>
<div class="pad-lr-10">
<form name="myform" action="?app=collection&controller=node&view=delete_type" method="post" onsubmit="checkuid();return false;">
<div class="table-list">
<table width="100%" cellspacing="0">
	<thead>
		<tr>
			<th width="35" align="center"><input type="checkbox" value="" id="check_box" onclick="selectall('typeid[]');"></th>
			<th width="80"><?php echo L('分类排序')?></th> 
			<th><?php echo L('分类名称')?></th>
			<th width="12%" align="center"><?php echo L('分类ID')?></th> 
			<th width="20%" align="center"><?php echo L('管理')?></th>
		</tr>
	</thead>
<tbody>
<tr>
		...
		<td align="center" width="12%"> 0</td>
		 <td align="center" width="20%" style="color: #999"><font class="xbtn btn-white btn-xs"> 修改</font>    <font class="xbtn btn-white btn-xs"> 删除</font></td>
	</tr>
<?php
if(is_array($infos)){
...
?>
	<tr>
		...
		<td align="center" width="12%"> <?php echo $info['typeid'];?></td>
		 <td align="center" width="20%"><a class="xbtn btn-info btn-xs" href="###"
			...
			href='?app=collection&controller=node&view=delete_type&typeid=<?php echo $info['typeid']?>'
...
function edit(id, name) {
	...
	window.top.art.dialog({title:'<?php echo L('edit')?> '+name+' ',id:'edit',iframe:'?app=collection&controller=node&view=edit_type&typeid='+id,width:'480',height:'220'}, function(){var d = window.top.art.dialog({id:'edit'}).data.iframe;var form = d.document.getElementById('dosubmit');form.click();return false;}, function(){window.top.art.dialog({id:'edit'}).close()});
}
function checkuid() {
	var ids='';
