...
class dianping_tag {
	...
	public function __construct() {
		$this->dianping_db = shy_base::load_model('dianping_model');
		$this->dianping_data_db = shy_base::load_model('dianping_data_model');
		$this->dianping_type_db = shy_base::load_model('dianping_type_model');
 	}
