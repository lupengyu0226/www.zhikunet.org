...
class style extends admin {
	...
	public function __construct() {
		$this->filepath = SHY_PATH.'templates'.DIRECTORY_SEPARATOR;
		parent::__construct();
	}
	...
	public function init() {
		...
		$big_menu = array('javascript:window.top.art.dialog({id:\'import\',iframe:\'?app=template&controller=style&view=import\', title:\''.L('import_style').'\', width:\'500\', height:\'250\', lock:true}, function(){var d = window.top.art.dialog({id:\'import\'}).data.iframe;var form = d.document.getElementById(\'dosubmit\');form.click();return false;}, function(){window.top.art.dialog({id:\'import\'}).close()});void(0);', L('import_style'));
