...
class template_bak extends admin {
	...
	public function __construct() {
		...
		$this->filepath = SHY_PATH.'templates'.DIRECTORY_SEPARATOR.$this->style.DIRECTORY_SEPARATOR.$this->dir.DIRECTORY_SEPARATOR.$this->filename;
		$this->fileid = $this->style.'_'.$this->dir.'_'.$this->filename;
		$this->tpl_edit = shy_base::load_config('system', 'tpl_edit');
		$this->db = shy_base::load_model('template_bak_model');
	}
