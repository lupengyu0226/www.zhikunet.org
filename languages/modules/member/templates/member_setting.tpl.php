...
<form name="myform" action="?app=member&controller=member_setting&view=manage" method="post" id="myform">
	<table width="100%" class="table_form">
		...
		<tr>
			...
			<td> 
				...
				&nbsp;&nbsp;&nbsp;&nbsp;<a href="?app=sms&controller=sms&view=sms_setting"><font color=red>短信平台配置</font></a>
			</td>
		</tr>
		<!--配置用户自发短信提示信息，需要结合SHUYANG申请记录-->
