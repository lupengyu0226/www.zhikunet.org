...
<form name="myform" action="?app=member&controller=member_menu&view=listorder" method="post">
<div class="pad-lr-10">
...
<form name="myform" id="myform" action="?app=member&controller=member_menu&view=add" method="post">
...
<div class="common-form">
<form name="myform" id="myform" action="?app=member&controller=member_menu&view=edit" method="post">
<table width="100%" class="table_form contentWrap">
      <tr>
        <th width="200"><?php echo L('menu_parentid')?>：</th>
