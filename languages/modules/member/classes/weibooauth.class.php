...
class OAuthUtil { 
    ...
    // This function takes a input like a=b&view=c&d=e and returns the parsed 
...
{ 
     ...
     * @param mixed $accecss_token OAuth璁よ瘉杩斿洖镄则oken 
     * @param mixed $accecss_token_secret OAuth璁よ瘉杩斿洖镄则oken secret 
     * @return void 
     */ 
     ...
     *  
     * @access public 
     * @param int $page 杩斿洖缁撴灉镄勯〉搴忓佛銆?
     * @param int $count 姣忔杩斿洖镄勬渶澶ц褰曟暟锛埚嵆椤甸溃澶у皬锛夛紝涓嶅ぇ浜?00锛岄粯璁や负20銆?
     * @return array 
     */ 
     ...
     * @param string $text 瑕佸彂甯幂殑锲剧墖璺缎,鏀寔url銆俒鍙敮鎸乸ng/jpg/gif涓夌镙煎纺,澧炲姞镙煎纺璇蜂慨鏀筭et_image_mime鏂规硶] 
     * @return array 
     */ 
     ...
     *  
     * @access public 
     * @param mixed $sid 瑕佽幏鍙栧凡鍙戣〃镄勫井鍗欼D 
     * @return array 
     */ 
     ...
     *  
     * @access public 
     * @param bool $cursor 鍗曢〉鍙兘鍖呭惈100涓叧娉ㄥ垪琛紝涓轰简銮峰彇镟村鍒檆ursor榛樿浠?1寮€濮嬶紝阃氲绷澧炲姞鎴栧噺灏庆ursor鏉ヨ幏鍙栨洿澶氱殑鍏虫敞鍒楄〃 
     * @param bool $count 姣忔杩斿洖镄勬渶澶ц褰曟暟锛埚嵆椤甸溃澶у皬锛夛紝涓嶅ぇ浜?00,榛樿杩斿洖20 
     ...
     *  
     * @access public 
     * @param bool $cursor 鍗曢〉鍙兘鍖呭惈100涓蒙涓濆垪琛紝涓轰简銮峰彇镟村鍒檆ursor榛樿浠?1寮€濮嬶紝阃氲绷澧炲姞鎴栧噺灏庆ursor鏉ヨ幏鍙栨洿澶氱殑绮変笣鍒楄〃 
     * @param bool $count 姣忔杩斿洖镄勬渶澶ц褰曟暟锛埚嵆椤甸溃澶у皬锛夛紝涓嶅ぇ浜?00,榛樿杩斿洖20銆?
     * @param mixed $uid_or_name  瑕佽幏鍙栫殑 UID鎴栧井鍗氭樀绉?
     * @return array 
     */ 
     ...
     *  
     * @access public 
     * @param mixed $uid_or_name 瑕佸彇娑埚叧娉ㄧ殑鐢ㄦ埛UID鎴栧井鍗氭樀绉?
     * @return array 
     */ 
     ...
     * @access public 
     * @param int $page 椤电爜 
     * @param int $count 姣忔杩斿洖镄勬渶澶ц褰曟暟锛屾渶澶氲繑锲?00鏉★紝榛樿20銆?
     ...
     * @param mixed $text 瑕佸彂鐢熺殑娑堟伅鍐呭锛屾枃链ぇ灏忓繀椤诲皬浜?00涓眽瀛椼€?
     * @return array 
     */ 
     ...
     *  
     * @access public 
     * @param mixed $sid 杞彂镄勫井鍗欼D 
     * @param bool $text 娣诲姞镄勮浆鍙戜俊鎭€?
     * @return array 
     */ 
    ...
    /** 
     * 镓归噺缁熻寰崥镄勮瘎璁烘暟锛岃浆鍙戞暟锛屼竴娆¤姹傛渶澶氲幏鍙?00涓€?
     *  
     * @access public 
     * @param mixed $sids 寰崥ID鍙峰垪琛紝鐢ㄩ€楀佛闅斿紑 
     * @return array 
     */ 
    ...
    /** 
     * 杩斿洖鐢ㄦ埛镄勫彂甯幂殑链€杩?0鏉℃敹钘忎俊鎭紝鍜岀敤鎴锋敹钘忛〉闱㈣繑锲炲唴瀹规槸涓€镊寸殑銆?
     *  
     * @access public 
     * @param bool $page 杩斿洖缁撴灉镄勯〉搴忓佛銆?
     * @return array 
     */ 
