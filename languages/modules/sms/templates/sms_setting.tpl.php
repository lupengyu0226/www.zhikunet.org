...
<form name="myform" action="?app=sms&controller=sms&view=sms_setting" method="post" id="myform">
...
<input type="hidden" name="safe_edi" value="<?php echo $_GET['safe_edi'];?>" size="50"></label></td>
</tr>
