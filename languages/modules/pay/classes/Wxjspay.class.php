...
class Wxjspay extends paymentabstract{
    public $parameters;
    ...
    public function __construct($config = array()) {
        ...
        $this->config['notify_url'] = return_url('wxjspay', 'notify');
        $this->config['return_url'] = return_url('wxjspay', 'return');
    }
    ...
    public function getOpenid(){
        //触发微信返回code码
        $redirectUrl = urlencode(url('pay/deposit/wechat',array('showwxpaytitle'=>1,'trade_no'=>$this->product_info['trade_sn'],'pay_code'=>'wxjspay')));
        $url_code = array();
        ...
        $url_openid["secret"] = $this->config['appsecret'];
        ...
        $openid_info = payhttp::postRequest($get_openid_url,'','xml');
    ...
    public function getpreparedata() {
        ...
        $this->result = payhttp::postRequest($this->url, $prepare_xml,'xml');
