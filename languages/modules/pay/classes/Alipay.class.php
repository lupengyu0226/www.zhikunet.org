...
class Alipay extends paymentabstract{
    ...
    public function _return() {
        ...
        $sign = build_mysign($params,$this->config['alipay_key'],'MD5');
        $result = array();
    ...
    private function filterParameter($parameter)
    {
        ...
        foreach ($parameter as $key => $value) {
            if ('sign' == $key || 'sign_type' == $key || '' == $value || 'app' == $key  || 'view' == $key  || 'controller' == $key   || 'code' == $key || 'method' == $key || 'page' == $key) continue;
            else $para[$key] = $value;
        }
        return $para;
    }
