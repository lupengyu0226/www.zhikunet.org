...
shy_base::load_app_func('global','pay');
class receipts {
	...
	protected  static function connect() {
		self::$db = shy_base::load_model("pay_account_model");
	}
	...
	public static function amount($value, $userid = '' , $username = '', $trade_sn = '', $pay_type = '', $payment = '', $op_username = '', $status = 'succ', $note = '') {
		return self::_add(array('username'=>$username, 'userid'=>$userid,'money'=>$value, 'trade_sn'=>$trade_sn, 'pay_type'=>$pay_type, 'payment'=>$payment, 'status'=>$status, 'adminnote'=>$op_username, 'usernote'=>$note));
	}
