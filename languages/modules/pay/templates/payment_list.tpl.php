...
?>   
	...
	<a href="javascript:confirmurl('?app=pay&controller=payment&view=delete&id=<?php echo $info['pay_id']?>', '<?php echo L('confirm',array('message'=>$info['pay_name']))?>')"><?php echo L('plus_uninstall')?></a>
	<?php } else {?>
