...
?>
<div class="pad-10">
<form method="post" action="?app=announce&controller=admin_announce&view=add" name="myform" id="myform">
...
<tbody>
	...
	<tr>
		...
		<td id="show_template"><script type="text/javascript">$.getJSON('?app=admin&controller=category&view=public_tpl_file_list&style=<?php echo $info['default_style']?>&module=announce&templates=show&name=announce&safe_edi='+safe_edi, function(data){$('#show_template').html(data.show_template);});</script></td>
	</tr>
	<tr>
	...
	<tr>
		<th><strong><?php echo L('会员中心显示')?></strong></th>
		<td><input name="announce[mpass]" type="radio" value="1" checked>&nbsp;<?php echo L('yes')?>&nbsp;&nbsp;<input name="announce[mpass]" type="radio" value="0">&nbsp;<?php echo L('no')?></td>
	</tr>
	</tbody>
</table>
