...
<form method="post" action="?app=search&controller=search_admin&view=setting">
<div class="pad_10">
...
function test_sphinx() {
    ...
    $.post('?app=search&controller=search_admin&view=public_test_sphinx',{sphinxhost:$('#sphinxhost').val(),sphinxport:$('#sphinxport').val()}, function(data){
		message = '';
		if(data == 1) {
