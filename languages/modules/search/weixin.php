	...
	public function init() {
		...
		if(isset($_GET['q'])) {
			...
			if($page == 1 && $_GET['q']==$q) {//翻页不重复记录
				...
				if($search_word){
					$this->search_word_db->update( array('search_times'=>$search_word['search_times']+1, 'last_search_time'=>$time) ,array('id'=>$search_word['id']) );
			...
			include	template('search','weixin');
		} else {
