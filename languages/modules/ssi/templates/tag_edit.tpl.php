...
<div class="pad-10">
  <form action="?app=ssi&controller=ssi&view=edit&id=<?php echo $id?>" method="post" id="myform">
    <div>
<fieldset>
	...
	<table width="100%"  class="table_form">
      <tr>
            ...
            <td class="y-bg"><input type="text" name="name" size="25" id="name" value="<?php echo $data['name'];?>"><script type="text/javascript">$(function(){$("#name").formValidator({onshow:"<?php echo L('please_input_block_name')?>",onfocus:"<?php echo L('please_input_block_name')?>"}).inputValidator({min:1, onerror:'<?php echo L('please_input_block_name')?>'});});</script></td>
      </tr>

      <tr>
            <th valign="top"><?php echo L('block').L('id')?>：</th>
            <td class="y-bg"><input type="text" name="tag" size="25" id="tag" value="<?php echo $data['tag'];?>"></td>
      </tr>
  <tr>
    ...
    <tr>
		...
		<td class="y-bg"><textarea name="data" id="data" style="width:500px;height:200px;"><?php echo $data['data'];?></textarea></td>
  </tr>


	<tr>
		<th width="80"><?php echo L('cache_times')?>：</th>
		<td class="y-bg"><input type="text" name="cache" id="cache" size="30" value="<?php echo $data['cache'];?>" /></td>
	</tr>
