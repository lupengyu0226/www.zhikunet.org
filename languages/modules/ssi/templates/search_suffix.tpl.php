...
<input type="hidden" name="view" value="public_search_suffix">
...
<!--
	...
	$("input[type='checkbox'][name='ids[]']:checked").each(function(i,n){parent.insert_forms_suffix(<?php  echo $_GET['contentid'];?>,$(n).val());});
