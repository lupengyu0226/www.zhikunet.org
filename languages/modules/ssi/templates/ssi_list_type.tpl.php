...
?>
<div class="pad-lr-10">
<form name="myform" action="?app=ssi&controller=ssi&view=delete_type" method="post" onsubmit="checkuid();return false;">
	...
	<tr>
		...
		<td align="center" width="12%"> <?php echo $info['typeid'];?></td>
		 <td align="center" width="20%"><a class="xbtn btn-info btn-xs" href="###"
			...
			href='?app=ssi&controller=ssi&view=delete_type&typeid=<?php echo $info['typeid']?>'
...
function edit(id, name) {
	...
	window.top.art.dialog({title:'<?php echo L('edit')?> '+name+' ',id:'edit',iframe:'?app=ssi&controller=ssi&view=edit_type&typeid='+id,width:'480',height:'220'}, function(){var d = window.top.art.dialog({id:'edit'}).data.iframe;var form = d.document.getElementById('dosubmit');form.click();return false;}, function(){window.top.art.dialog({id:'edit'}).close()});
}
function checkuid() {
	var ids='';
