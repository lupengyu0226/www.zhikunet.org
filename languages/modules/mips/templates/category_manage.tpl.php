...
<form name="myform" action="?app=mips&controller=category&view=listorder" method="post">
<div class="pad_10">
<div class="explain-col">
<?php echo L('category_cache_tips');?>，<a href="?app=mips&controller=category&view=public_cache&menuid=43&module=mips"><?php echo L('update_cache');?></a>
</div>
<div class="bk10"></div>
