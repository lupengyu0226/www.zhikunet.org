...
<div class="pad-10">
    <div class="col-tab">
        <ul class="tabBut cu-li">
            ...
            <li id="tab_swf_3" onclick="SwapTab('swf','on','',5,3);set_iframe('album_list','index.php?app=attachment&controller=attachments&view=album_load&args=<?php echo $args?>');"><?php echo L('gallery')?></li>
            <li id="tab_swf_4" onclick="SwapTab('swf','on','',5,4);set_iframe('album_dir','index.php?app=attachment&controller=attachments&view=album_dir&args=<?php echo $args?>');"><?php echo L('directory_browse')?></li>
            <?php }?>
            <?php if($att_not_used!='') {?>
...
function album_cancel(obj,id,source){
	...
	if($(obj).hasClass('on')){
		...
		var strs = filenames = '';
		$.get('index.php?app=attachment&controller=attachments&view=swfupload_json_del&aid='+id+'&src='+source+'&filename='+filename);
		...
		$(obj).addClass("on");
		$.get('index.php?app=attachment&controller=attachments&view=swfupload_json&aid='+id+'&src='+source+'&filename='+filename);
