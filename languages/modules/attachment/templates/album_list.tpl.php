...
<input type="hidden" value="attachments" name="controller">
<input type="hidden" value="album_load" name="view">
...
function album_cancel(obj,id,source){
	...
	if($(obj).hasClass('on')){
		...
		var strs = filenames = '';
		$.get('index.php?app=attachment&controller=attachments&view=swfupload_json_del&aid='+id+'&src='+source);
		...
		$(obj).addClass("on");
		$.get('index.php?app=attachment&controller=attachments&view=swfupload_json&aid='+id+'&src='+source);
