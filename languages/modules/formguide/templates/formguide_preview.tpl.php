...
?>
<script language="javascript" type="text/javascript" src="http://statics.05273.cn/statics/js/dialog.js"></script>
...
　 <?php if(isset($big_menu)) echo '<a class="add fb" href="'.$big_menu[0].'"><em>'.$big_menu[1].'</em></a>　';?><a class="on" href="?app=formguide&controller=formguide&view=init"><em><?php echo L('return_list')?></em></a></div>
</div>
<div class="pad-10">
