...
<form name="myform" action="?app=message&controller=message&view=delete_group" method="post" onsubmit="checkuid();return false;">
...
if(is_array($infos)){
	...
	<tr>
		...
		<td align="center" width="10%"> <a
			href='?app=message&controller=message&view=delete_group&message_group_id=<?php echo $info['id']?>'
