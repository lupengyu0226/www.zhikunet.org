...
<form action="?app=content&controller=create_html&view=show" method="post" name="myform">
...
<!--
	...
	function change_model(modelid) {
		window.location.href='?app=content&controller=create_html&view=show&modelid='+modelid+'&safe_edi='+safe_edi;
	}
//-->
</script>
