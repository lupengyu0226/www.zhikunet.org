...
<form action="?app=content&controller=create_html&view=update_urls" method="post" name="myform">
...
<!--
	...
	function change_model(modelid) {
		...
		window.location.href='?app=content&controller=create_html&view=update_urls&modelid='+modelid+'&safe_edi='+safe_edi;
	}
//-->
</script>
