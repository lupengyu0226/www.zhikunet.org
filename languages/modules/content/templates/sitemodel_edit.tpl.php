...
<div class="pad-lr-10">
<form action="?app=content&controller=sitemodel&view=edit" method="post" id="myform">
<fieldset>
...
function load_file_list(id) {
	$.getJSON('?app=admin&controller=category&view=public_tpl_file_list&style='+id, function(data){$('#category_template').html(data.category_template);$('#list_template').html(data.list_template);$('#show_template').html(data.show_template);});
}
