...
<script>
			...
			// 上传地址，使用了 base64 加密
			flashvars.uploadurl = "<?php echo base64_encode("index.php?app=attachment&controller=attachments&view=crop_upload&module=$module&catid=$catid&file=".urlencode($picurl));?>";
