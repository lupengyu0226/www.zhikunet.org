...
<form action="?app=content&controller=create_html&view=category" method="post" name="myform">
...
<?php echo $string;?>
      ...
      <td><font color="red"><?php echo L('every_time');?> <input type="text" name="pagesize" value="20" size="4"> <?php echo L('information_items');?></font></td>
    </tr>
	<tr> 
...
<!--
	...
	function change_model(modelid) {
		window.location.href='?app=content&controller=create_html&view=category&modelid='+modelid+'&safe_edi='+safe_edi;
	}
//-->
</script>
