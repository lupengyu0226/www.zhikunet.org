...
class RSSBuilder extends RSSBase {
	...
	*/
	function createOutputV091() {
		...
		if (strlen($this->language) > 0) {
			$this->output .= (string) '<language>' . $this->language?$this->language:'zh-cn' . '</language>' . "\n";
		} // end if
	...
	*/
	function createOutputV200() {
		...
		//if (strlen($this->creator) > 0) {
		//	$this->output .= (string) '<generator>' . $this->generator . '</generator>' . "\n";
		//} // end if
	...
	*/
	function outputRSS($version = '') {
		...
		$this->output = '<?xml version="1.0" encoding="' . $this->encoding . '"?>' . "\n" .
						'<?xml-stylesheet type="text/xsl" href="https://www.05273.cn/statics/images/rss_xml_style.css"?>'. "\n"  . $this->output;
		echo $this->output;
	} // end function
	...
	*/
	function getRSSOutput($version = '') {
		...
		return (string) '<?xml version="1.0" encoding="' . $this->encoding . '"?>' . "\n" .
						'<!--  RSS generated by ShuYangWang RSS Builder [' .  date('Y-m-d H:i:s')  .']  --> ' . $this->output;
	} // end function
	/**#@-*/
