...
<table cellpadding="2" cellspacing="1" width="98%">
  ...
  <tr> 
      <td>显示模式</td>
      <td><input type="radio" name="setting[show_type]" value="1" <?php if($setting['show_type']) echo 'checked';?>/> 预览模式 <input type="radio" name="setting[show_type]" value="0" <?php if(!$setting['show_type']) echo 'checked';?>/> 链接模式</td>
    </tr>
</table>
