...
<input type="hidden" value="xihuan" name="app">
<input type="hidden" value="xihuan_admin" name="controller">
...
<table width="100%" cellspacing="0">
	<thead>
		<tr>
			...
			<?php foreach ($xihuan_program as $k=>$v) {
...
?>
    <tr>
		...
		<?php foreach ($xihuan_program as $k=>$b) {
				$d = 'n'.$k;
