...
?>
<div class="pad_10">
<form action="?app=slider&controller=slider&view=edit&id=<?php echo $id; ?>" method="post" name="myform" id="myform">
<table cellpadding="2" cellspacing="1" class="table_form" width="100%">
    ...
    <tr>
		<th></th>
		<td><input type="hidden" name="forward" value="?app=slider&c=slider&view=edit"> <input
