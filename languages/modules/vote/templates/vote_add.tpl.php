...
<div class="pad_10">
<form action="?app=vote&controller=vote&view=add" method="post" name="myform" id="myform">
...
function load_file_list(id) {
	$.getJSON('?app=admin&controller=category&view=public_tpl_file_list&style='+id+'&module=vote&templates=vote_tp&name=vote_subject&safe_edi='+safe_edi, function(data){$('#show_template').html(data.vote_tp_template);});
}
</script>
