...
<form method="post" action="?app=vote&controller=vote&view=setting">
...
function load_file_list(id) {
	$.getJSON('?app=admin&controller=category&view=public_tpl_file_list&style='+id+'&module=vote&templates=vote_tp&name=setting&safe_edi='+safe_edi, function(data){$('#show_template').html(data.vote_tp_template);});
}
</script>
