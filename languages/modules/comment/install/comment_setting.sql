DROP TABLE IF EXISTS `shuyang_comment_setting`;
CREATE TABLE IF NOT EXISTS `shuyang_comment_setting` (
...
INSERT INTO `shuyang_comment_setting` (`siteid`, `guest`, `check`, `code`, `add_point`, `del_point`) VALUES (1, 0, 0, 0, 0, 0);
