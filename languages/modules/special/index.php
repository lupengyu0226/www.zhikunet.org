...
class index {
	...
	public function show() {
		...
		$page = $_GET['page'];
		$c_db = shy_base::load_model('special_content_model');
		$c_data_db = shy_base::load_model('special_c_data_model');
		...
		if ($_special['isvideo']) {
			$video_store = shy_base::load_model('video_store_model');
	...
	public function comment() {
		...
		$userid = param::get_cookie('_userid');
		if (!$userid) {
			showmessage(L('login_website'), PASSPORT_PATH.'member-index.html');
		}
