...
include $this->admin_tpl('header', 'admin');
 ?>
<form method="post" action="?app=special&controller=special&view=add" id="myform">
<div class="pad-10">
<div class="col-tab">
...
$(document).ready(function(){
	...
	$('#title').formValidator({autotip:true,onshow:"<?php echo L('please_input_special_title')?>",onfocus:"<?php echo L('min_3_title')?>",oncorrect:"<?php echo L('true')?>"}).inputValidator({min:1,onerror:"<?php echo L('please_input_special_title')?>"}).ajaxValidator({type:"get",url:"",data:"app=special&controller=special&view=public_check_special",datatype:"html",cached:false,async:'true',success : function(data) {
        if( data == "1" )
		{
            return true;
		}
