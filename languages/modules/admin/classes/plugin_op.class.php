...
class plugin_op {
	...
	public function __construct(){
		...
		$this->db = shy_base::load_model('plugin_var_model');
	}
	/**
	 * 插件后台模板加载
	 */	
	public function plugin_tpl($file,$identification) {
		return SHY_PATH.'plugin'.DIRECTORY_SEPARATOR.$identification.DIRECTORY_SEPARATOR.'templates'.DIRECTORY_SEPARATOR.'admin'.DIRECTORY_SEPARATOR.$file.'.tpl.php';
	}
