...
<div class="row1">
  <div id="mboxs" class="mbox">
    <div>
        ...
        <a <?php if($f['islink']) {?>href="<?php echo $f['url']?>" target="_blank"<?php } else {?> href="?app=admin&controller=plugin&view=appcenter_detail&id=<?php echo $f['appid']?>"<?php } ?>><img src="<?php echo $f['thumb']?>"/></a>
		<?php } ?>
  ...
  <div class="rr2">
    <div class="row2">
      ...
      <ul class="r cola li20" id="ul0s">
        ...
        <li>
          <div><a href="?app=admin&controller=plugin&view=appcenter_detail&id=<?php echo $r['id']?>" title="test" rel="<?php echo $r['id']?>"><img src="<?php echo $r['thumb'] ? $r['thumb'] : IMG_PATH.'zz_bg.jpg'?>" width="55" height="55" /></a><a href="?app=admin&controller=plugin&view=appcenter_detail&id=<?php echo $r['id']?>" title="test" class="mgt6"><?php echo $r['appname']?></a></div>
        </li>
         <?php }?>
  ...
  <div class="rr3 cr">
    <div class="row4">
      <ul class="col col4 fy" id="ul1s">
        ...
        <li>
          <div><a href="?app=admin&controller=plugin&view=appcenter_detail&id=<?php echo $r['id']?>" title="<?php echo $r['appname']?>" rel="<?php echo $r['id']?>"><img src="<?php echo $r['thumb'] ? $r['thumb'] : IMG_PATH.'zz_bg.jpg'?>" width="55" height="55" /></a>
...
<script type="text/javascript">
	...
	function get_ajx_detail(id) {
		$.getJSON('?app=admin&controller=plugin&view=public_appcenter_ajx_detail&jsoncallback=?&id='+id+'&safe_edi='+safe_edi,function(a){
