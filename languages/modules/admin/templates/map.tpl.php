...
<li><a href="javascript:go('index.php?app=<?php echo $r['m']?>&controller=<?php echo $r['c']?>&view=<?php echo $r['a']?>&safe_edi=<?php echo $_SESSION['safe_edi']?>&menuid=<?php echo $r['id']?><?php echo isset($r['data']) ? $r['data'] : ''?>')"><?php echo L($r['name'])?></a></li>
