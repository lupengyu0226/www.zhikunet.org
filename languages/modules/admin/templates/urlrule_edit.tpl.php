...
<form action="?app=admin&controller=urlrule&view=edit" method="post" name="myform" id="myform">
	<tr> 
	...
	<tr> 
      <th width="20%"><?php echo L('urlrule_func')?> :</th>
       <td><?php echo L('complete_part_path');?>： <input type="text" name="f1" value="{$categorydir}" size="15" class="input-botton">，<?php echo L('category_path');?>：<input type="text" name="f1" value="{$catdir}" size="10" class="input-botton">，<?php echo L('MD5');?>：<input type="text" name="f1" value="{$mid}" size="10" class="form-control">
	   <div class="bk6"></div>
