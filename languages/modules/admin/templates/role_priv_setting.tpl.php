...
<div style="padding:6px 3px">
      ...
      <h6><img src="<?php echo IMG_PATH?>icon/sitemap-application-blue.png" width="16" height="16" /> <?php echo L('site_select');?></h6>
       <div id="site_list">
          ...
          <?php foreach($sites_list as $n=>$r) {?>
            ...
            <li><a href="?app=admin&controller=role&view=role_priv&siteid=<?php echo $r['siteid']?>&roleid=<?php echo $roleid?>" target="role"><span><img src="<?php echo IMG_PATH?>icon/gear_disable<?php echo $green?>.png" width="16" height="16" /><?php echo L('sys_setting');?></span><em><?php echo $r['name']?></em></a></li>
           <?php } ?>
      </ul>
      </div>
    </div>
    <div class="col-2 col-auto">
        ...
        <iframe name="role" id="role" src="?app=admin&controller=role&view=role_priv&safe_edi=<?php echo $_SESSION['safe_edi']?>" frameborder="false" scrolling="auto" style="overflow-x:hidden;border:none" width="100%" height="483" allowtransparency="true"></iframe>
        </div>
    </div>
</div>
</body>
