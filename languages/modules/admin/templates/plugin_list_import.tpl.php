...
?>   
	...
	<td width="15%" align="center"><a href="?app=admin&controller=plugin&view=import&dir=<?php echo $info['dir']?>&menuid=<?php echo $_GET['menuid']?>"><?php echo L('plugin_install','','plugin')?></a></td>
	</tr>
<?php 
	}
}
