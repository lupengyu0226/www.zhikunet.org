...
<form name="myform" action="?app=admin&controller=category&view=listorder" method="post">
<div class="pad_10">
<div class="explain-col">
<?php echo L('category_cache_tips');?>，<a href="?app=admin&controller=category&view=public_cache&menuid=43&module=admin"><?php echo L('update_cache');?></a>
</div>
<div class="bk10"></div>
<div class="table-list">
    <table width="100%" cellspacing="0" >
        <thead>
            ...
            <th align='center' width="100"><?php echo L('vistor');?></th>
            <th align='center' width="80"><?php echo L('domain_help');?></th>
			<th align="center" width="30%"><?php echo L('operations_manage');?></th>
            </tr>
        </thead>
    <tbody>
    <?php echo $categorys;?>
