...
<form action="?app=admin&controller=badword&view=add" method="post" name="myform" id="myform">
 	<tr> 
...
<input type="hidden" name="forward" value="?app=admin&controller=badword&view=add"> 
