...
<ul class="tabBut cu-li">
            <li id="tab_setting_1" class="on" onclick="SwapTab('setting','on','',5,1);"><i class="iconfont icon-shezhi"></i> <?php echo L('catgory_basic');?></li>
            <li id="tab_setting_2" onclick="SwapTab('setting','on','',5,2);"><i class="iconfont icon-html"></i> <?php echo L('catgory_createhtml');?></li>
            <li id="tab_setting_3" onclick="SwapTab('setting','on','',5,3);"><i class="iconfont icon-houtaimobanguanlinew"></i> <?php echo L('catgory_template');?></li>
            <li id="tab_setting_4" onclick="SwapTab('setting','on','',5,4);"><i class="iconfont icon-seo"></i> <?php echo L('catgory_seo');?></li>
            <li id="tab_setting_5" onclick="SwapTab('setting','on','',5,5);"><i class="iconfont icon-quanxian"></i> <?php echo L('catgory_private');?></li>
</ul>
...
<!--
	...
	function load_file_list(id) {
		if(id=='') return false;
		$.getJSON('?app=admin&controller=category&view=public_tpl_file_list&style='+id+'&catid=<?php echo $parentid?>&type=1', function(data){$('#page_template').html(data.page_template);});
	}
