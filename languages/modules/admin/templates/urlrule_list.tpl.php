...
function edit(id) {
	...
	window.top.art.dialog({title:'<?php echo L('edit_urlrule');?>《'+id+'》',id:'edit',iframe:'?app=admin&controller=urlrule&view=edit&urlruleid='+id,width:'750',height:'300'}, function(){var d = window.top.art.dialog({id:'edit'}).data.iframe;d.document.getElementById('dosubmit').click();return false;}, function(){window.top.art.dialog({id:'edit'}).close()});
}
//-->
</script>
</body>
