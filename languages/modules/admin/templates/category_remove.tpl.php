...
<div class="content-menu ib-a blue line-x"><a href="?app=content&controller=content&view=init&catid=46" class=on><em><?php echo L('remove','','content');?></em></a> 
</div>
<div class="bk10"></div>
<form action="?app=admin&controller=category&view=remove" method="post" name="myform">
