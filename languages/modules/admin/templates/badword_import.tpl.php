...
<form action="?app=admin&controller=badword&view=import" method="post" name="myform">
 	<tr> 
...
<?php echo L('badword_import_infos')?>
    ...
    <tr> 
      <th></th>
      <td> 
	  <input type="hidden" name="forward" value="?app=admin&controller=badword&view=import"> 
