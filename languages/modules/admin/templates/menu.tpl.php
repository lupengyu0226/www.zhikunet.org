...
<?php if(ROUTE_A=='init') {?>
<form name="myform" action="?app=admin&controller=menu&view=listorder" method="post">
<div class="pad-lr-10">
...
<!--
    ...
    //$("#icon").formValidator({onshow:"<?php echo L("input").L('字体库中的图标')?>",onfocus:"<?php echo L("input").L('字体库中的图标')?>",oncorrect:"<?php echo L('input_right');?>"}).inputValidator({min:1,onerror:"<?php echo L("input").L('字体库中的图标')?>"});
...
<form name="myform" id="myform" action="?app=admin&controller=menu&view=add" method="post">
...
<?php echo $select_categorys;?>
      ...
      <tr>
        <th><?php echo L('图标')?>：</th>
        <td><input type="text" name="info[icon]" id="icon" class="input-text" ></td>
      </tr>
	<tr>
...
<div class="common-form">
<form name="myform" id="myform" action="?app=admin&controller=menu&view=edit" method="post">
<table width="100%" class="table_form contentWrap">
      <tr>
        <th width="200"><?php echo L('menu_parentid')?>：</th>
...
<?php echo $select_categorys;?>
      ...
      <tr>
        <th><?php echo L('图标')?>：</th>
        <td><input type="text" name="info[icon]" id="icon" class="input-text" value="<?php echo $icon?>"></td>
      </tr>
	<tr>
        <th><?php echo L('module_name')?>：</th>
