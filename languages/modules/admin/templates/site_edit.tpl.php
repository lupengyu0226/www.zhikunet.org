...
<div class="pad-10">
<form action="?app=admin&controller=site&view=edit&siteid=<?php echo $siteid?>" method="post" id="myform">
<fieldset>
...
<input type="text" class="input-text" name="setting[watermark_minwidth]" id="watermark_minwidth" size="10" value="<?php echo $setting['watermark_minwidth'] ? $setting['watermark_minwidth'] : '300' ?>" /> X <?php echo L('site_att_watermark_minheight')?><input type="text" class="input-text" name="setting[watermark_minheight]" id="watermark_minheight" size="10" value="<?php echo $setting['watermark_minheight'] ? $setting['watermark_minheight'] : '300' ?>" /> PX
  ...
  <tr>
    <th><?php echo L('图片限制')?></th>
    <td class="y-bg"><?php echo L('site_att_watermark_minwidth')?>
<input type="text" class="input-text" name="setting[thumb_width]" id="thumb_width" size="10" value="<?php echo $setting['thumb_width'] ? $setting['thumb_width'] : '800' ?>" /> X <?php echo L('site_att_watermark_minheight')?><input type="text" class="input-text" name="setting[thumb_height]" id="thumb_height" size="10" value="<?php echo $setting['thumb_height'] ? $setting['thumb_height'] : '0' ?>" /> PX
     </td>
  </tr>
  <tr>
