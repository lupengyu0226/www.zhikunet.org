...
<script type="text/javascript">
  $(document).ready(function() {
	...
	$("#old_password").formValidator({empty:false,onshow:"<?php echo L('input').L('old_password')?>",onfocus:"<?php echo L('password').L('between_6_to_20')?>",oncorrect:"<?php echo L('old_password_right')?>"}).inputValidator({min:6,max:20,onerror:"<?php echo L('password').L('between_6_to_20')?>"}).ajaxValidator({
	    type : "get",
		url : "",
		data :"app=admin&controller=admin_manage&view=public_password_ajx",
		datatype : "html",
		async:'false',
...
<form name="myform" action="?app=admin&controller=admin_manage&view=public_edit_pwd" method="post" id="myform">
