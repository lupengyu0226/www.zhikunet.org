...
?>
<div class="pad-lr-10">
<form name="searchform" action="?app=admin&controller=ipbanned&view=search_ip&menuid=<?php echo $_GET['menuid'];?>" method="get" >
...
?>
	...
	<input type="checkbox" name="ipbannedid[]" value="<?php echo $info['ipbannedid']?>">
        ...
        <td align="center"><?php echo date('Y-m-d H:i', $info['expires']);?></td>
         <td align="center"><a href="javascript:confirmurl('?app=admin&controller=ipbanned&view=delete&ipbannedid=<?php echo $info['ipbannedid']?>', "<?php echo L('confirm_del_ip')?>")"><?php echo L('delete')?></a> </td>
    </tr>
<?php
	}
}
