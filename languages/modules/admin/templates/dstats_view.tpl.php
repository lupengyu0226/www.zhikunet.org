...
<div class="pad_10">
	<div class="content-menu ib-a blue line-x">
        <a  href="javascript:;" class="on"><em>多用户统计</em></a>
        <span>|</span>
        <a href="?app=admin&controller=manage_stats&view=viewByUser"><em>单用户统计</em></a>
 	</div>
	<div class="explain-col">
		<form name="searchform" action="" method="get" >
		<input type="hidden" value="admin" name="app">
		<input type="hidden" value="manage_stats" name="controller">
		<input type="hidden" value="viewByTime" name="view">
		从 <?php echo form::date('start_time',$start_time)?>
