...
<script type="text/javascript">
  $(document).ready(function() {
	...
	$("#lockscreen").formValidator({empty:true,onshow:"<?php echo L('not_change_the_password_please_leave_a_blank')?>",onfocus:"<?php echo L('lockscreen').L('between_6_to_20')?>"}).inputValidator({min:6,max:20,onerror:"<?php echo L('lockscreen').L('between_6_to_20')?>"});
...
<form name="myform" action="?app=admin&controller=admin_manage&view=edit" method="post" id="myform">
...
<td><input type="password" name="info[lockscreen]" id="lockscreen" class="input-text"></input></td>
</tr>
<tr>
