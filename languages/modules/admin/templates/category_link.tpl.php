...
<form name="myform" id="myform" action="?app=admin&controller=category&view=<?php echo ROUTE_A;?>" method="post">
<div class="pad-10">
<div class="col-tab">

<ul class="tabBut cu-li">
            <li id="tab_setting_1" class="on" onclick="SwapTab('setting','on','',1,1);"><i class="iconfont icon-shezhi"></i> <?php echo L('catgory_basic');?></li>
</ul>
