...
<form name="myform" action="?app=admin&controller=category&view=batch_edit" method="post">
<div class="pad_10">
...
function load_file_list(id,catid) {
	if(id=='') return false;
	$.getJSON('?app=admin&controller=category&view=public_tpl_file_list&batch_str=1&type=1&style='+id+'&catid='+catid, function(data){
