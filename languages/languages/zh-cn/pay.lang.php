...
$LANG['wxpay'] = '微信支付';
$LANG['wxpay_account'] = '微信支付帐户';
$LANG['wxpay_tip'] = '微信支付是腾讯公司的支付业务品牌，微信支付提供公众号支付、APP支付、扫码支付、刷卡支付等支付方式。微信支付结合微信公众账号，全面打通O2O生活消费领域，提供专业的互联网+行业解决方案，微信支付支持微信红包和微信理财通，是移动支付的首选。';
$LANG['wxpay_key'] = '交易安全校验码(key)';
$LANG['wxpay_partner'] = '合作者身份(parterID)';
...
$LANG['unpay'] = '<i class="iconfont icon-cuowu1" style="color:red"></i> <font color="red">交易未支付</font>';
$LANG['succ'] = '<i class="iconfont icon-checkbox" style="color:red"></i> <font color="green">交易成功</font>';
$LANG['failed'] = '交易失败';
$LANG['error'] = '交易错误';
$LANG['progress'] = '<font color="orange" class="onTime">交易处理中</font>';
$LANG['timeout'] = '<i class="iconfont icon-jinyong" style="color:red"></i> <font color="red">交易超时</font>';
$LANG['cancel'] = '<i class="iconfont icon-jinyong" style="color:red"></i> <font color="red">交易取消</font>';
...
$LANG['wxpay'] = '微信扫码支付';
$LANG['wxjspay'] = '微信公众号支付';
$LANG['wxpay_tip'] = '微信支付是腾讯公司的支付业务品牌,微信支付提供公众号支付、APP支付、扫码支付、刷卡支付等支付方式。';
$LANG['mchid'] = '微信支付商户号（MCHID）';
$LANG['key'] = 'API密钥（KEY）';
$LANG['appid'] = '开发者ID(AppID)';
$LANG['appsecret'] = '开发者密码(AppSecret)';
?>
