...
$LANG['cofirmpwd'] = '确认密码';
$LANG['realname'] = '真实姓名';
$LANG['enable_phpsso'] = '需开启用户中心';
$LANG['enable_register'] = '注册功能';
$LANG['nameerror'] = '用户名不能为空。';
$LANG['between_2_to_10'] = '应该为2-10位之间';
...
$LANG['lock'] = '锁定';
$LANG['user_is_lock'] = '注册虽成功，能用算你赢！你已被锁定';
$LANG['unlock'] = '解锁';
$LANG['move'] = '移动';
...
$LANG['user_not_exist'] = '用户不存在或密码错误';
...
$LANG['sina_login_notice'] = '使用新浪微博连接登录沭阳网,将精彩内容分享到新浪微博。';
$LANG['qq_login_notice'] = '使用腾讯微博连接登录沭阳网,将精彩内容分享到腾讯微博。';
$LANG['snda_login_notice'] = '使用用盛大连接登录沭阳网,轻松使用盛大所有服务。';
...
//新增被封原因
$LANG['yuanyin'] = '被封原因';
$LANG['status_1'] = '<font color="red">已处理,感谢反馈</font>';
$LANG['status_0'] = '<font color="blue">尚未处理</font>';
?>