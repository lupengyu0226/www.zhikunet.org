...
//index
$LANG['admin_site_title'] = '智库网 - 后台管理中心';
$LANG['expand_or_contract'] = '展开与收缩';
$LANG['shuyang_title'] = '智库网内容管理系统';
...
$LANG['pagecount_cron'] = '页面数';
//main
$LANG['main_hello'] = '您好，';
$LANG['main_role'] = '所属角色：';
$LANG['main_last_logintime'] = '本次登录时间：';
$LANG['main_last_loginip'] = '本次登录IP：';
$LANG['main_safety_tips'] = '安全提示';
$LANG['main_safety_permissions'] = '※ 强烈建议您将系统核心目录设置为755（linux/unix）或只读（NT）';
...
$LANG['main_product_team'] = '网站系统开发团队';
...
$LANG['setting_debug'] = '启用调试模式';
$LANG['setting_delpanel'] = '锁定快捷栏';
$LANG['setting_js_path'] = 'JS路径';
$LANG['setting_css_path'] = 'CSS路径';
$LANG['setting_img_path'] = '图片路径';
$LANG['setting_passport_path'] = '通行证地址';
...
$LANG['setting_safe_model'] = '安全策略';
$LANG['setting_safe_off'] = '启用开启安全策略';
...
<B>互联网新闻开放协议：</B> <br>
1、互联网新闻开放协议》是百度新闻搜索制定的搜索引擎新闻源收录标准，网站可将发布的新闻内容制作成遵循此开放协议的XML格式的网页（独立于原有的新闻发布形式）供搜索引擎索引。 本系统可自动生成网站的Sitemaps，但是您还需要向google或者baidu提交Sitemaps的访问地址。<br>
您的网站的Sitemaps 访问地址为：<?=APP_PATH?>sitemaps.xml<br>
本系统可自动生成网站的<<互联网新闻开放协议>>，但是您还需要向baidu提交访问地址。<br>
...
$LANG['domain_name_format'] = '域名可为空，格式应该为http://www.zhikunet.org/';
$LANG['domain_end_string'] = '格式应该为http://www.zhikunet.org/，请以‘/’结束';
...
$LANG['site_domain_ex'] = '请填写域名，格式为：http://www.zhikunet.org/';
$LANG['site_domain_ex2'] = '格式应该为http://www.zhikunet.org/，请以‘/’结束';
...
$LANG['update_formguide_model'] = '表单向导模型';
$LANG['update_vote_setting']	= '投票模块配置';
$LANG['update_link_setting']	=	'友情链接模块配置';
$LANG['update_mip_index']	=	'MIP首页';
$LANG['linkage'] = '联动菜单';
$LANG['module'] = '模块';
$LANG['position'] = '推荐位';
$LANG['admin_role'] = '角色';
...
$LANG['modelid_edit_tips'] = ' <img src="http://statics.zhikunet.org/statics/images/icon/help.gif" title="当该栏目下数据为 0 时，可更换模型">';
...
$LANG['safe_off_tips'] = '<font color="#959595">警告</font>:网站当前防御系统已关闭';
...
//admin_manage.php lockscreen

$LANG['lockscreen'] = '锁屏密码';
$LANG['lockscreentips'] = '锁屏密码,默认为12345678';
$LANG['oldlockscreen'] = '旧锁屏密码';
$LANG['newlockscreen'] = '新锁屏密码';
$LANG['lockscreenconfirm'] = '重复新密码';
$LANG['lockscreen_edit_succ'] = '锁屏密码修改成功';
?>