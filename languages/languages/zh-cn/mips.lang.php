...
$LANG['mips_edit'] = '修改';
$LANG['mips_delete'] = '删除';
$LANG['mips_type_manage'] = '栏目管理';
$LANG['mips_type_edit'] = '分类编辑';
$LANG['mips_type_delete'] = '分类删除';
$LANG['mips_del_cofirm'] = '确认删除?';
$LANG['phpcms_friends'] = '手机网友';
$LANG['confirm_delete'] = '确认删除选择的分类吗？';
$LANG['mips_add_site'] = '添加手机站点';
$LANG['parameter_error'] = '参数错误';
$LANG['mips_add_site'] = '添加手机站点';
$LANG['mips_del_succ'] = '删除成功';
$LANG['mips_change_status'] = '更新状态成功';
$LANG['mips_add_samesite_error'] = '请勿重复添加相同站点';
$LANG['mips_empty_type'] = '分类名称为空';
$LANG['mips_empty_bound_type'] = '绑定栏目为空';
$LANG['mips_repeat_bound_error'] = '该栏目已绑定过，无法重复绑定';
$LANG['mips_add_subtype'] = '＋添加子分类';
$LANG['mips_repeat_bound'] = '栏目绑定重复';
$LANG['mips_type_del_error'] = '该分类含有子栏目，请先删除其子栏目';
$LANG['mips_permission_denied_del'] = '无权限删除该站点';
...
$LANG['mips_sel_site'] = '选择要开启的站点：';
$LANG['mips_belong_site'] = '所属站点：';
$LANG['mips_sitename'] = '站点名称：';
$LANG['mips_logo'] = '手机门户站点LOGO：';
$LANG['mips_domain'] = '绑定域名';
$LANG['mips_listnum'] = '列表页条数：';
$LANG['mips_thumb'] = '缩略图尺寸：';
$LANG['mips_content_page'] = '内容页分页字节数：';
$LANG['mips_index_tpl'] = '首页模板：';
$LANG['mips_cat_tpl'] = '频道页模板：';
$LANG['mips_list_tpl'] = '列表页模板：';
$LANG['mips_show_tpl'] = '内容页模板：';
$LANG['mips_hotword'] = '热词';
$LANG['mips_open'] = '开启';
$LANG['mips_close'] = '关闭';
$LANG['mips_type_manage'] = '栏目管理';
$LANG['mips_type_name'] = '分类名称  ';
$LANG['mips_toptype_add'] = '添加顶级分类';
$LANG['mips_type_bound'] = '选择要绑定的栏目';
$LANG['mips_bound_type'] = '绑定栏目';
$LANG['mips_guestbook'] = '发表留言成功!页面正在返回……';
$LANG['mips_goback'] = '返回正文页';
$LANG['mips_close_status'] = '您访问的站点不存在或者未开启手机访问';
$LANG['catname'] = '栏目名称';
