...
$LANG['website_manage'] = '沭阳网 - 后台管理中心';
$LANG['lockscreen'] = '锁屏';
$LANG['submit'] = '提 交';
$LANG['yes'] = '是';
$LANG['no'] = '否';
...
$LANG['items'] = '数据量';
$LANG['status'] = '状态';
$LANG['icon_unlock'] = '<i class="iconfont icon-checkbox" style="color:red"></i>';
$LANG['icon_locked'] = '<i class="iconfont icon-cuowu1" style="color:#3498db"></i>';
$LANG['type'] = '类型';
$LANG['search'] = '搜索';
$LANG['username'] = '用户名';
...
$LANG['copyright'] = 'CopyRight 2006-2012  <a href="http://www.sdo.com" target="_blank">上海盛大网络发展有限公司</a> B2-20040053 <a href="http://www.05273.cn" target="_blank">SHUYANG TEAM</a> ';
...
$LANG['att_upload_not_allow_scanv'] = '附件安全检测失败上传终止';
