...
$LANG['check_file_notice'] = 'Note: File verification is a comparable result between all files of the root directory, all files and subdirectories under shuyang, api, statics folder and MD5 value of same name in default program. If an exception occurs, please scan your files to detect the Trojan file';
