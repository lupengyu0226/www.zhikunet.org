...
weatherInfo.prototype = {
    ...
    getWeatherInfo: function () {
        ...
        function getDayWeather(wInfo, icoUrl, wtObj, bgOnNight, icoOnNight){
            ...
            $.ajax({
                url: "https://weather.gtimg.cn/aqi/cityrank.json",
                dataType: "jsonp",
            ...
            $.ajax({
                url: "https://weather.gtimg.cn/aqi/" + cityId + ".json",
                dataType: "jsonp",
                jsonpCallback: "city",
                success: function() {}
            });*/
        ...
        // 城市接口数据
        this.loadJs('https://weather.gtimg.cn/city/' + cityId + '.js', 'gb2312', 'weatherJs', function () {
