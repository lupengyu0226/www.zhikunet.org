$(document).ready(function(){
	...
	$("#big-pica").html("<p style='text-indent:0em;'><img src='"+url+"' onload='loadpic("+next_picid+")'></p>");
	$('#big-pica img').LoadImage(true, 600, 580,$("#load_pic").attr('rel'));
	$("#picnum").html("(当前第"+picid+"张，总共"+totalnum+"张)");
...
function showpic(type, replay) {
	...
	if(type=='next' || type=='pre') {
		...
		$("#picnum").html("(当前第"+i+"张，总共"+totalnum+"张)");
