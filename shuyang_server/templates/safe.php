...
feitian_error();
//引用配置文件
require_once('shuyang_cache.php');
//防护脚本版本号
...
<head>
<meta charset="utf-8">
<title>沭阳网 - 提示信息</title>
<script language="JavaScript" src="https://statics.05273.cn/statics/js/admin_common.js"></script>
...
<div class="wrap">
  <div id="error_tips">
    ...
    <div class="error_cont">
      <ul>
        <li>你输入的参数已被飞天系统拦截</li>
      </ul>
      <div class="error_return">
		    如果你的浏览器没有自动跳转，<a href="https://www.05273.cn/">请点击这里</a>
			<script language="javascript">setTimeout("redirect('https://www.05273.cn/');",1250);</script> 
			</div>
    </div>
  </div>
</div>
