...
if(is_file($_SERVER['DOCUMENT_ROOT'].'/templates/safe.php')){
    require_once($_SERVER['DOCUMENT_ROOT'].'/templates/safe.php');
} 
//SHUYANG框架路径
...
//缓存文件夹地址
define('CACHE_PATH', SHY_PATH.'..'.DIRECTORY_SEPARATOR.'caches'.DIRECTORY_SEPARATOR);
//主机协议
...
//管理员安全码
define('SAFE_CODE',shy_base::load_config('system','safe_code'));
