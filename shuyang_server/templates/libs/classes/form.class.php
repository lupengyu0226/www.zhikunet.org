...
class form {
	...
	public static function editor($textareaid = 'content', $toolbar = 'basic', $module='', $catid='', $color = '', $allowupload = 0, $allowbrowser = 1,$alowuploadexts = '') {
		...
		if($toolbar=='basic') {
		    ...
		    ['Link','Unlink','Anchor'],
		    ['Image','yinyue','Flash','Table','HorizontalRule','Smiley','SpecialChar','PageBreak'],
		    '/',
        ...
        if($allowupload) $str .= "filebrowserUploadUrl : '?app=attachment&controller=attachments&view=upload&dosubmit=1',\r\n";
		if($color) {
	...
	public static function select_template($module, $id = '', $str = '', $pre = '') {
		...
		$tpl_name = shy_base::load_config('system','tpl_name');
		$templatedir = SHY_PATH.$tpl_root.DIRECTORY_SEPARATOR.$tpl_name.DIRECTORY_SEPARATOR.$module.DIRECTORY_SEPARATOR;
