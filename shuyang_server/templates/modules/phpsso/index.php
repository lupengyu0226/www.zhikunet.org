...
shy_base::load_app_class('phpsso', 'phpsso', 0);
...
class index extends phpsso {
	...
	public function __construct() {
		parent::__construct();
		$this->config = shy_base::load_config('system');
	...
	public function register() {
		...
		if ($this->config['ucuse']) {
			shy_base::load_config('uc_config');
			require_once SHUYANG_PATH.'api/uc_client/client.php';
	...
	public function login() {
		...
		//如果开启shuyang_2008_sp4兼容模式，根据sp4规则验证密码，如果不成功再根据phpsso规则验证密码
	...
	public function uploadavatar() {
		...
		//创建图片存储文件夹
		$avatarfile = shy_base::load_config('system', 'upload_path').'avatar/';
