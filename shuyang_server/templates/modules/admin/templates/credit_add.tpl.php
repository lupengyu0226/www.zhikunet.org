...
<div class="subnav">
  <h2 class="title-1 line-x f14 fb blue lh28"><?php echo L('credit_add')?></h2>
	<div class="content-menu ib-a blue line-x">
		<a href="?app=admin&controller=credit&view=manage">
		<em><?php echo L('credit_manage')?></em></a>
		<span>|</span>
		<a href="?app=admin&controller=credit&view=add" class="on">
		<em><?php echo L('credit_add')?></em></a>
	</div>
</div>
<div class="pad-lr-10">
<form method=post action="?app=admin&controller=credit&view=add">
...
<!--
	function showcredit(pos, val) {
		$.post('?app=admin&controller=credit&view=creditlist&appid='+val+'&'+Math.random(),function(data){
