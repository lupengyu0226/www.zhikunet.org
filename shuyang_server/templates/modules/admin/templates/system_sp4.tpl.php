...
<div class="subnav">
	...
	<div class="content-menu ib-a blue line-x"><a href="?app=admin&controller=system&view=init"><em><?php echo L('register_setting')?></em></a><span>|</span> <a href="?app=admin&controller=system&view=uc"><em><?php echo L('uc_setting')?></em></a><span>|</span><a href="?app=admin&controller=system&view=sp4" class="on"><em><?php echo L('sp4_password_compatible')?></em></a></div>
</div>
<div class="pad-lr-10">
<form action="?app=admin&controller=system&view=sp4" method="post" name="form_messagequeue_manage">
