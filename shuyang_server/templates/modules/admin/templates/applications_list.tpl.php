...
<div class="content-menu ib-a blue line-x"><a href="?app=admin&controller=applications&view=init" class="on"><em><?php echo L('application_list')?></em></a><span>|</span> <a href="?app=admin&controller=applications&view=add"><em><?php echo L('application_add')?></em></a></div>
</div>
...
<div class="table-list pad-lr-10">
    ...
    <?php foreach ($list as $v):?>
        <tr>
			...
			<td align="center"><a href="?app=admin&controller=applications&view=edit&appid=<?php echo $v['appid']?>">[<?php echo L('edit')?>]</a>&nbsp;|&nbsp;<a href="?app=admin&controller=applications&view=del&appid=<?php echo $v['appid']?>" onclick="return confirm('<?php echo L('sure_delete')?>')">[<?php echo L('delete')?>]</a></td>
		</tr>
      <?php endforeach;?>
    </table>
...
<!--
	function check_status(id) {
		$.get('?app=admin&controller=applications&view=check_status&appid='+id+'&'+Math.random(),function(data){
			if(data == 1) {
