...
<div class="content-menu ib-a blue line-x"><a href="?app=admin&controller=administrator&view=init"><em><?php echo L('listadmins')?></em></a><span>|</span> <a href="?app=admin&controller=administrator&view=add"><em><?php echo L('add_admin')?></em></a></div>
</div>
<div class="pad-lr-10">
<form action="?app=admin&controller=administrator&view=edit&id=<?php echo $id?>" method="post" id="myform">
