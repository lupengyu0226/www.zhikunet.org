...
<div class="subnav">
	...
	<div class="content-menu ib-a blue line-x">
		<a href="?app=admin&controller=credit&view=manage" class="on">
		<em><?php echo L('credit_manage')?></em></a>
		<span>|</span>
		<a href="?app=admin&controller=credit&view=add">
		<em><?php echo L('credit_add')?></em></a>
	</div>
</div>

<form action="?app=admin&controller=credit&view=delete" method="post" name="form_member_manage">
