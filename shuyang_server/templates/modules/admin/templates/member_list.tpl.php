...
<div class="subnav">
    ...
    <div class="rt">
		...
		<a href="?app=admin&controller=member&view=manage" class="on">
		<em><?php echo L('member_manage')?></em></a>
		<span>|</span>
		<a href="?app=admin&controller=member&view=add">
		<em><?php echo L('member_add')?></em></a>
	</div>
</div>
<div class="pad-lr-10">
<form action="?app=admin&controller=member&view=delete" method="post" name="form_member_manage">
...
?>
	<tr>
		...
		<td align="left"><a href="?app=admin&controller=member&view=edit&uid=<?php echo $v['uid']?>">[<?php echo L('edit')?>]</a></td>
	</tr>
<?php
}	
?>   </tbody>
